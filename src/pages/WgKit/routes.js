export default [
  { path: 'colors', component: () => import('@/pages/WgKit/ColorsDemo') },
  { path: 'text', component: () => import('@/pages/WgKit/TextDemo') },
  { path: 'buttons', component: () => import('@/pages/WgKit/ButtonsDemo') },
